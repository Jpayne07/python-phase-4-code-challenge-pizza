...
Revision ID: 610de6abb3b0
Revises: 
Create Date: 2024-12-11 22:01:33.995549
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['restuarant_id'], ['restaurants.id'], name=op.f('fk_restaurant_pizzas_restuarant_id_restaurants')),
    sa.PrimaryKeyConstraint('id')
    )
